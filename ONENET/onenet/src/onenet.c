...
//	
	...
	{
//		UsartPrintf(Usart_Num_1, "WARN:	连接失败：协议错误\r\n");
		ESP8266_SendData(mqttPacket._data, mqttPacket._len);			//上传平台
//		UsartPrintf(Usart_Num_1, "ERR:	连接\r\n");
...
//			UsartPrintf(Usart_Num_1,"2\r\n");
			if(MQTT_UnPacketRecv(dataPtr) == MQTT_PKT_CONNACK)
			{
				...
				{
					case 0:
  						UsartPrintf(Usart_Num_1, "Tips:	连接成功\r\n");status = 0;
					    break;
					
//					case 1:UsartPrintf(Usart_Num_1, "WARN:	连接失败：协议错误\r\n");break;
//					case 2:UsartPrintf(Usart_Num_1, "WARN:	连接失败：非法的clientid\r\n");break;
//					case 3:UsartPrintf(Usart_Num_1, "WARN:	连接失败：服务器失败\r\n");break;
//					case 4:UsartPrintf(Usart_Num_1, "WARN:	连接失败：用户名或密码错误\r\n");break;
//					case 5:UsartPrintf(Usart_Num_1, "WARN:	连接失败：非法链接(比如token非法)\r\n");break;
					
					default:
  						UsartPrintf(Usart_Num_1, "ERR:	连接失败：未知错误\r\n");
					    break;
				}
			}
		}
