...
void Gp_906_Init()
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GP906_GPIO_Port, ENABLE);

    /*配置SMBUS_SCK、SMBUS_SDA为集电极开漏输出*/
    GPIO_InitStructure.GPIO_Pin = GP906_GPIO_Pin_Num_Scl | GP906_GPIO_Pin_Num_Sda;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GP906_GPIO_Port, &GPIO_InitStructure);
...
*******************************************************************************/
void Gp906_ReadTemp(float *Temp)
{   
